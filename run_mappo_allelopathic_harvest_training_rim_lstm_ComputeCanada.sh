...
#SBATCH --output=logs/mappo-train-allelopathic-harvest-rim-lstm-seed-1_%N-%j.out
#SBATCH --error=logs/mappo-train-allelopathic-harvest-rim-lstm-seed-1_%N-%j.err
...
CUDA_VISIBLE_DEVICES=0 python3 -m onpolicy.scripts.train.train_meltingpot --use_valuenorm False --use_popart False --use_gae True --env_name "Meltingpot" --algorithm_name "mappo" \
     --experiment_name "allelopathic_harvest_trillium_rim_lstm_bengio_mgn04_enco3_lr00006" --substrate_name "allelopathic_harvest__open" --num_agents 16 --seed 30 --lr 0.00006 \
     --critic_lr 0.00007 --n_rollout_threads 22 --max_grad_norm 0.04 --use_wandb True --user_name "irina-rish" --wandb_name "irina-rish" --value_loss_coef 0.5 \
     ...
     --slot_att_crop_repeat 9 --slot_log_fre 10 --collect_data False --no_train False --use_orthogonal True --gain 0.01 --drop_out 0.2 \
     --gamma 0.995 --clip_param 0.1 --gae_lambda 0.96