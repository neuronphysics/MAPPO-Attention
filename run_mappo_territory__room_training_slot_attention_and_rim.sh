...
#SBATCH --time=3-10:46:59                                   # The job will run for 3 hours
...
srun python3 train_meltingpot.py --use_valuenorm False --use_popart True --env_name "Meltingpot" --algorithm_name "mappo" \
	...
	--num_env_steps 4000000 --log_interval 5 --load_model True --episode_length 1000 --downsample True --img_scale_factor 1 \
	...
	--slot_att_crop_repeat 9 --slot_log_fre 5 --collect_data False --collect_agent False --collect_world True --collect_data_ep_num 20 --no_train False \
