...
srun python3 train_meltingpot.py --use_valuenorm False --use_popart True --env_name "Meltingpot" --algorithm_name "mappo" --use_gae True \
	--experiment_name "train_slot_qsa_rim_territory_rooms_mgn01" --substrate_name "territory__rooms" --num_agents 9 --seed 123 --lr 0.00002 --critic_lr 0.00002 \
	--n_rollout_threads 1 --max_grad_norm 0.01 --use_wandb True --user_name "zsheikhb" --wandb_name "zsheikhb" --share_policy False \
	--use_centralized_V False --use_attention True --entropy_coef 0.01 --attention_module "RIM" --rnn_attention_module LSTM --rim_num_units 6 --rim_topk 4 \
	--hidden_size 300 --num_env_steps 4000000 --log_interval 5 --load_model True --episode_length 1000 --downsample True --img_scale_factor 1 \
	--world_img_scale_factor 8 --pretrain_slot_att False --slot_train_ep 150 \
	--slot_pretrain_batch_size 1000 --slot_att_work_path "/home/mila/z/zahra.sheikhbahaee/Projects/meltingpot/slot_att_qsa/onpolicy/scripts/results/slot_att/" \
	...
	--slot_att_crop_repeat 9 --slot_log_fre 10 --collect_data False --collect_agent False --collect_world True --collect_data_ep_num 20 --no_train False \
