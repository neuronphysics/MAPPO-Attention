...
#SBATCH --output=logs/mappo-train-allelopathic-harvest-rim-lstm-hyperparam-1_%N-%j.out
#SBATCH --error=logs/mappo-train-allelopathic-harvest-rim-lstm-hyperparam-1_%N-%j.err
...
CUDA_VISIBLE_DEVICES=0 python3 -m onpolicy.scripts.train.train_meltingpot --use_valuenorm False --use_popart False --use_gae True --env_name "Meltingpot" --algorithm_name "mappo" \
     --experiment_name "allelopathic_harvest_rim_lstm_trillium_mgn05_enco3_lr00005" --substrate_name "allelopathic_harvest__open" --num_agents 16 --seed 42 --lr 0.00005 \
     ...
     --slot_att_crop_repeat 9 --slot_log_fre 10 --collect_data False --no_train False --use_orthogonal True --gain 0.04 --gamma 0.995 \
     --clip_param 0.1 --gae_lambda 0.96 --drop_out 0.2
