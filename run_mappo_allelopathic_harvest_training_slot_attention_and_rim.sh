...
CUDA_VISIBLE_DEVICES=0 python3 -m onpolicy.scripts.train.train_meltingpot --use_valuenorm True --use_popart True --use_gae True --env_name "Meltingpot" --algorithm_name "mappo" \
     --experiment_name "allelopathic_harvest_mila_nu8_slot_attention_QSA_RIM_GRU" --substrate_name "allelopathic_harvest__open" --num_agents 16 --seed 999 --lr 0.00006 --critic_lr 0.00007 --n_rollout_threads 20 \
	 ...
	 --entropy_final_coef 0.005 --warmup_updates 200000 --cooldown_updates 100000 --entropy_anneal_duration 500000 --attention_module "RIM" --rnn_attention_module "GRU" --rim_num_units 8 --rim_topk 4 \
	 ...
	 --slot_train_ep 200 --slot_pretrain_batch_size 48 --use_slot_att True --use_pos_encoding True --use_input_att False --use_com_att True --use_x_reshape True \
	 ...
	 --lr_main 0.00009 --use_orthogonal_loss True --orthogonal_loss_coef 0.1 --use_EWC False --perturb_interval 1456000 --num_iter 2 --ppo_epoch 10 --num_mini_batch 2
