...
#SBATCH --time=2-03:23:59                                   # The job will run for 3 hours
...
CUDA_VISIBLE_DEVICES=0 python3 -m onpolicy.scripts.train.train_meltingpot --use_valuenorm True --use_popart True --use_gae True --env_name "Meltingpot" --algorithm_name "mappo" \
     --experiment_name "allelopathic_harvest_mila_nu8_slot_attention_QSA_RIM_LSTM" --substrate_name "allelopathic_harvest__open" --num_agents 16 --seed 999 --lr 0.00006 --critic_lr 0.00007 --n_rollout_threads 16 \
	 ...
	 --lr_main 0.00009 --use_orthogonal_loss True --orthogonal_loss_coef 0.1 --use_EWC False --perturb_interval 1456000
