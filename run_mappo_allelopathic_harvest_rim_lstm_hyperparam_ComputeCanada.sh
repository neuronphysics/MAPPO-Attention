...
#SBATCH --output=/home/memole/projects/def-irina/memole/logs/mappo-allelopathic_harvest-RIM-LSTM-parameter-search-seed-1_%N-%j.out
#SBATCH --error=/home/memole/projects/def-irina/memole/logs/mappo-allelopathic_harvest-RIM-LSTM-parameter-search-seed-1_%N-%j.err
...
CUDA_VISIBLE_DEVICES=0 python3 -m onpolicy.scripts.train.train_meltingpot --use_valuenorm False --use_popart False --use_gae True --env_name "Meltingpot" --algorithm_name "mappo" \
   --experiment_name "allelopathic_harvest_rim_lstm_fir_mgn05_lr00005" --substrate_name "allelopathic_harvest__open" --num_agents 16 --seed 42 --lr 0.00005 --critic_lr 0.00006 \
   --n_rollout_threads 25 --max_grad_norm 0.05 --use_wandb True --user_name "irina-rish" --wandb_name "irina-rish" --entropy_coef 0.3 --entropy_final_coef 0.001 --warmup_updates 0 --cooldown_updates 50000 \
   --entropy_anneal_duration 100000 --share_policy False --use_centralized_V False --use_attention True --rnn_attention_module "LSTM" --attention_module "RIM" --rim_num_units 8 \
