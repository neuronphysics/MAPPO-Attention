...
parser.add_argument('--use_valuenorm', type=bool, default=True, help="whether to use")

parser.add_argument('--algorithm_name', type=str, default="mappo")

parser.add_argument('--cuda', type=bool, default=True)

parser.add_argument('--env_name', type=str, default="Meltingpot")
...
parser.add_argument('--use_render', type=bool, default=False)
...
parser.add_argument('--num_env_steps', type=int, default=20000)
...
parser.add_argument('--wandb_name', type=str, default='dane-malenfant')

parser.add_argument('--share_policy', type=bool, default=False)
...
parser.add_argument("--episode_length", type=int,
                    default=20, help="Max length for any episode")
...
parser.add_argument("--critic_lr", type=float, default=2e-5,
...
parser.add_argument("--use_recon_loss", default=True,
