...
#SBATCH --time=1-10:40:59                                   # The job will run for 3 hours
#SBATCH -o /home/mila/z/zahra.sheikhbahaee/Projects/meltingpot/logs/slurm-territory_rooms-pretrain-QSA-%j.out  # Write the log on scratch
#SBATCH -e /home/mila/z/zahra.sheikhbahaee/Projects/meltingpot/logs/slurm-territory_rooms-pretrain-QSA-%j.err  # Write the err on scratch
...
srun python3 train_meltingpot.py --use_valuenorm False --use_popart True --env_name "Meltingpot" --algorithm_name "mappo" \
     ...
     --critic_lr 0.00002 --n_rollout_threads 1 --max_grad_norm 0.01 --use_wandb True --user_name "zsheikhb" --wandb_name "zsheikhb" \
     ...
     --world_img_scale_factor 8 --pretrain_slot_att False --slot_train_ep 150 --slot_pretrain_batch_size 200 \
    ...
    python3 train_meltingpot.py --use_valuenorm False --use_popart True --env_name "Meltingpot" --algorithm_name "mappo" \
     --experiment_name "data_collect_only" --substrate_name "territory__rooms" --num_agents 9 --seed 123 --lr 0.00002 \
     --critic_lr 0.00002 --n_rollout_threads 1 --max_grad_norm 0.01 --use_wandb True --user_name "zsheikhb" --wandb_name "zsheikhb" \
     --share_policy False --use_centralized_V False --use_attention True --entropy_coef 0.004 --attention_module "RIM" --rim_num_units 6 \
     --rim_topk 4 --hidden_size 300 --num_env_steps 4000000 --log_interval 1 --episode_length 1000 --downsample False --img_scale_factor 1 \
     --world_img_scale_factor 1 --pretrain_slot_att False --slot_train_ep 150 --slot_pretrain_batch_size 200 \
     --slot_att_work_path "/home/mila/z/zahra.sheikhbahaee/Projects/meltingpot/slot_att_qsa/onpolicy/scripts/results/slot_att/" \
     --slot_att_load_model False --use_slot_att False --use_pos_encoding False --use_input_att False --use_com_att True --use_x_reshape True \
     --slot_att_crop_repeat 9 --slot_log_fre 1 --collect_data True --collect_agent False --collect_world True --collect_data_ep_num 20 \
     --no_train True --crop_size 88