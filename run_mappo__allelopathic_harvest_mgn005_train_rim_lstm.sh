...
CUDA_VISIBLE_DEVICES=0 python3 train_meltingpot.py --use_valuenorm False --use_popart True --env_name "Meltingpot" --algorithm_name "mappo" \
     --experiment_name "harvest_rim_LSTM_nu6_tk_4_mgn005_EntCoef_005" --substrate_name "allelopathic_harvest__open" --num_agents 16 --seed 123 --lr 0.00001 --critic_lr 0.00001 \
     --n_rollout_threads 4 --max_grad_norm 0.005 --use_wandb True --user_name "zsheikhb" --wandb_name "zsheikhb" --share_policy False \
     --use_centralized_V False --use_attention True --entropy_coef 0.005 --attention_module "RIM" --rim_num_units 6 --rim_topk 4 \
