...
#SBATCH -o /home/mila/z/zahra.sheikhbahaee/Projects/meltingpot/logs/slurm-cleanup-train-QSA-RIM-%j.out  # Write the log on scratch
#SBATCH -e /home/mila/z/zahra.sheikhbahaee/Projects/meltingpot/logs/slurm-cleanup-train-QSA-RIM-%j.err  # Write the err on scratch
...
srun python3 train_meltingpot.py --use_valuenorm False --use_popart True --env_name "Meltingpot" --algorithm_name "mappo" --use_gae True \
	--experiment_name "train_slot_qsa_rim_cleanup_mgn2"  --substrate_name "clean_up" --num_agents 7 --seed 123 --lr 0.00006 --critic_lr 0.0001 \
	--n_rollout_threads 1 --max_grad_norm 0.2 --use_wandb True --user_name "zsheikhb" --wandb_name "zsheikhb" --share_policy False \
	--use_centralized_V False --use_attention True --entropy_coef 0.3 --entropy_final_coef 0.006 --attention_module "RIM" --rnn_attention_module "LSTM" --rim_num_units 6 --rim_topk 4 \
