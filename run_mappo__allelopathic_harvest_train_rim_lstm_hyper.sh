...
#SBATCH -o /home/mila/z/zahra.sheikhbahaee/Projects/meltingpot/logs/slurm-allelopathic_harvest-train-LSTM-%j.out  # Write the log on scratch
#SBATCH -e /home/mila/z/zahra.sheikhbahaee/Projects/meltingpot/logs/slurm-allelopathic_harvest-train-LSTM-%j.err  # Write the err on scratch
...
CUDA_VISIBLE_DEVICES=0 python3 -m onpolicy.scripts.train.train_meltingpot --use_valuenorm False --use_popart False --env_name "Meltingpot" --algorithm_name "mappo" \
    --use_gae True --experiment_name "allelopathic_harvest_RIM_mgn08_lr00006_nu8_tk_6" --substrate_name "allelopathic_harvest__open" --num_agents 16 \
    --seed 42 --lr 0.00006 --critic_lr 0.00006 --n_rollout_threads 20 --max_grad_norm 0.08 --use_wandb True --user_name "irina-rish" --wandb_name "irina-rish" \
    --share_policy False --use_centralized_V False --use_attention True --entropy_coef 0.08 --entropy_final_coef 0.004 --warmup_updates 50000 --cooldown_updates 50000 \
    --entropy_anneal_duration 400000 --attention_module "RIM" --rim_num_units 8 --rim_topk 6 --hidden_size 192 --num_env_steps 4000000 --log_interval 1 --episode_length 2000 \
