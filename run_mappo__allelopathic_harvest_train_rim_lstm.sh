...
CUDA_VISIBLE_DEVICES=0 python3 train_meltingpot.py --use_valuenorm False --use_popart True --env_name "Meltingpot" --algorithm_name "mappo" \
     --experiment_name "harvest_rim_LSTM_nu6_tk_4_mgn05" --substrate_name "allelopathic_harvest__open" --num_agents 16 --seed 123 --lr 0.00002 --critic_lr 0.00002 \
     ...
     --hidden_size 240 --num_env_steps 4000000 --log_interval 1 --episode_length 1000 --downsample True --img_scale_factor 8 \
