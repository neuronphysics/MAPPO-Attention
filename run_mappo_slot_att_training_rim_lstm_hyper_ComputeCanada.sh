...
#SBATCH --output=logs/mappo-attention-train-harvest-rim-seed-1_%N-%j.out
#SBATCH --error=logs/mappo-attention-train-harvest-rim-seed-1_%N-%j.err
...
CUDA_VISIBLE_DEVICES=0 python3 -m onpolicy.scripts.train.train_meltingpot --use_valuenorm False --use_popart False --use_gae True --env_name "Meltingpot" --algorithm_name "mappo" \
     --experiment_name "allelopathic_harvest_trillium_rim_lstm_lr00006" --substrate_name "allelopathic_harvest__open" --num_agents 16 --seed 123 --lr 0.00006 \
     --critic_lr 0.00007 --n_rollout_threads 25 --max_grad_norm 0.05 --use_wandb True --user_name "irina-rish" --wandb_name "irina-rish" \
     --entropy_coef 0.1 --entropy_final_coef 0.001 --warmup_updates 10000 --cooldown_updates 50000 --entropy_anneal_duration 400000 \
     --share_policy False --use_centralized_V False --use_attention True --rnn_attention_module "LSTM" --attention_module "RIM" --rim_num_units 8 \
     --rim_topk 6 --hidden_size 192 --num_env_steps 4000000 --log_interval 1 --episode_length 2000 --downsample True --img_scale_factor 8 \
     ...
     --slot_att_crop_repeat 9 --slot_log_fre 10 --collect_data False --ppo_epoch 10 \
     --no_train False --use_orthogonal True --gain 0.01 --drop_out 0.2 --gamma 0.995 --clip_param 0.2 --gae_lambda 0.96
