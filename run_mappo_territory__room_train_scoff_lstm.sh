...
#SBATCH -o /home/mila/z/zahra.sheikhbahaee/Projects/meltingpot/logs/slurm-territory_rooms-train-SCOFF-LSTM-%j.out  # Write the log on scratch
#SBATCH -e /home/mila/z/zahra.sheikhbahaee/Projects/meltingpot/logs/slurm-territory_rooms-train-SCOFF-LSTM-%j.err  # Write the err on scratch
...
CUDA_VISIBLE_DEVICES=0 python3 train_meltingpot.py --use_valuenorm False --use_popart True --env_name "Meltingpot" --algorithm_name "mappo" \
     --experiment_name "SCOFF_LSTM_nu6_tk_4_mgn05" --substrate_name "territory__rooms" --num_agents 9 --seed 123 --lr 0.00002 --critic_lr 0.00002 \
     --n_rollout_threads 4 --max_grad_norm 0.05 --use_wandb True --user_name "zsheikhb" --wandb_name "zsheikhb" --share_policy False \
     --use_centralized_V False --use_attention True --entropy_coef 0.004 --attention_module "SCOFF" --rim_num_units 6 --rim_topk 4 \
