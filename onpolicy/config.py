...
def get_config():
    ...
    parser.add_argument("--shrink_factor", type=float, default=0.985)
    parser.add_argument("--perturb_epsilon", type=float, default=0.015)
    ...
    parser.add_argument('--use_EWC', type=str2bool, default=True, help="whether to use Elastic Weight Consolidation or only weight clipping")
