...
class STEVEEncoder(nn.Module):
    def __init__(self, args):
        ...
        self.pos = CartesianPositionalEmbedding(args.d_model,
...
class STEVE(nn.Module):
    ...
    def forward(self, video, tau, hard):
        ...
        z_emb = torch.cat([self.steve_decoder.bos.expand(B * T, -1, -1), z_emb],
                          dim=1)  # B * T, 1 + H_enc * W_enc, d_model
