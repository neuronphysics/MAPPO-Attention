...
from onpolicy.algorithms.utils.dinosaur.ocl.utils.bboxes import box_cxcywh_to_xyxy
...
class LatentDupplicateSuppressionLoss(nn.Module):
    ...
    def forward(self, grouping: PerceptualGroupingOutput) -> float:
...
class CLIPLoss(nn.Module):
    ...
    def forward(
        self,
        first: PooledFeatures,
        second: PooledFeatures,
