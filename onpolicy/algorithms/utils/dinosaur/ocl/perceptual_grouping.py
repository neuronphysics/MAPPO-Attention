...
class SlotAttentionGrouping(nn.Module):
    ...
    def forward(
        self,
        feature: FeatureExtractorOutput,
        conditioning: ConditioningOutput,
        slot_mask: Optional[EmptyIndicator] = None,
    ) -> PerceptualGroupingOutput:
        ...
        return PerceptualGroupingOutput(
...
class StickBreakingGrouping(nn.Module):
    ...
    def forward(
        self, features: FeatureExtractorOutput
    ) -> PerceptualGroupingOutput:
...
class KMeansGrouping(nn.Module):
    ...
    def forward(
        self, feature: FeatureExtractorOutput
    ) -> PerceptualGroupingOutput:
        feature = feature.features
